...
sims_pop |>
  ...
  summarize(p_identify_mixed = mean(group == "AB")) |>
  ungroup() |>
  ggplot(aes(x = scenario, y = p_identify_mixed, group = mar_growth,
             color = mar_growth))+
...
#| fig-cap: Distribution of share of ancestry from Group A among those who have mixed ancestry at the end of the simulation. Distribution is estimated and smoothed using kernel density. Dotted vertical lines indicate the starting share of Group A population in each scenario. 
...
```{r}
#| label: fig-mixed-ancestry-shar-timee
#| fig-cap: The percent of the population with mixed ancestry over time, across scenarios
