...
#| fig-cap: Distribution of share of ancestry from Group A among those who have mixed ancestry at the end of the simulation
#| eval: false

# one option would be to show the histograms of group A ancestry across each case at the end of the scenario
