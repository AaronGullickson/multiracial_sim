...
#| fig-cap: The percent of the population with mixed ancestry regardless of identification, over time and across scenarios
...
#| fig-cap: The percent of the population identified as mixed (AB), over time and across scenarios
...
total_pop_group |>
  ...
  labs(y = "share of population identifying as mixed (AB)",
       color = "classification/nscenario")+
  theme_bw()
```
