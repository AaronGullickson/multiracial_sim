...
#| fig-cap: Estimated log odds ratio of an intergroup union in each year of simulation in the plateau and progress scenarios. Smoothed lines are estimated via a Generalized Additive Model (GAM). 
